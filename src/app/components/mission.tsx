                ...
                <div className='max-w-7xl mx-auto px-4 lg:px-8'>
                    ...
                    <div className="max-w-7xl mx-auto px-4 lg:px-8">
                        <div className='md:mx-16 mx-8 text-center '>
                            <p className='my-4'>The IEEE Computer Society ISSATM SBC (IEEE CS ISSATM) is the premier source for
                    ...
                    <div
                        ...
                        <div className="">
                            <p className="text-ieeeyellow font-bold text-xl lg:text-2xl"><CountUp end={65}
                                                                                                  duration={10}/>+</p>
                        ...
                        <div className="">
                            <p className="text-ieeeyellow font-bold text-xl lg:text-2xl"><CountUp end={2}
                                                                                                  duration={4}/>+</p>
